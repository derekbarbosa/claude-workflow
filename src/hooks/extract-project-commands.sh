...
Examples:
  $0 /home/user/proj/my-project
  $0 /home/user/proj/my-project custom-commands.json
EOF
}
...
main() {
    ...
    echo "   2. Test with: $CLAUDE_FILES_DIR/hooks/manage-hooks.sh test $project_dir/some-file"
    echo "   3. Enable hooks: $CLAUDE_FILES_DIR/hooks/manage-hooks.sh enable"
}
